			...
			<div class="row justify-content-center">
				...
				<form method="post" action="./validarPass.php" class="login-form">
		      		...
		      		<div class="form-group">
		      			...
		      			<input name="correu" type="mail" class="form-control" placeholder="Correo de recuperacion" required>
		      		</div>
	            <div class="form-group">
	            	<button type='submit' class="btn form-control btn-primary rounded submit px-3">Enviar Correu</button>
